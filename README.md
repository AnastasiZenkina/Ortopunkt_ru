...
Система состоит из 7 модулей, разделённых по зонам ответственности:  
...
- структурированная REST-документация (Swagger / OpenAPI)
- полный список эндпоинтов всех микросервисов
- схемы запросов и ответов для всех DTO
- описание ошибок и используемых статус-кодов

Полная документация доступна локально при запуске (CRM-service → `/swagger-ui`)
